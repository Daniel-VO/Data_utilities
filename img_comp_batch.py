"""
Created 15. April 2020 by Daniel Van Opdenbosch, Technical University of Munich
...
def func(i):
	...
	if width>2048 and width>=height:
		os.system('convert "'+i+'" -resize 2048x'+str(int(height*width/2048))+'\> '+operator+' "'+i+'"')
	if height>2048 and height>=width:
		os.system('convert "'+i+'" -resize '+str(int(height*width/2048))+'x2048\> '+operator+' "'+i+'"')
